...
export const metadata: Metadata = {
  title: 'Contact',
  description: 'Get in touch with Junto United.',
}
    ...
    <section className="max-w-3xl mx-auto px-6 py-20">
      <FadeIn>
        ...
        <p className="text-charcoal/50 text-lg max-w-lg mb-12 leading-relaxed">
          Whether you are building something ambitious, thinking about a
          collaboration, or just want to exchange ideas &mdash; we are interested.
        </p>
      </FadeIn>
